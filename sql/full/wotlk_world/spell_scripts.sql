...
-- Exportiere Daten aus Tabelle wotlk_world.spell_scripts: 170 rows
/*!40000 ALTER TABLE `spell_scripts` DISABLE KEYS */;
REPLACE INTO `spell_scripts` (`id`, `effIndex`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `x`, `y`, `z`, `o`, `Comment`) VALUES
	...
	(25952, 0, 0, 18, 3000, 0, 0, 0, 0, 0, 0, 'Reindeer Dust Effect - On Effect Hit (Dummy) - Caster - Delayed Despawn'),
