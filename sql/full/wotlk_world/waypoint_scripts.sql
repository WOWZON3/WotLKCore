...
-- Exportiere Daten aus Tabelle wotlk_world.waypoint_scripts: 709 rows
/*!40000 ALTER TABLE `waypoint_scripts` DISABLE KEYS */;
REPLACE INTO `waypoint_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `x`, `y`, `z`, `o`, `guid`, `Comment`) VALUES
