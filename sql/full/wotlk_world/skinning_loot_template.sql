...
-- Exportiere Daten aus Tabelle wotlk_world.skinning_loot_template: 1.639 rows
...
REPLACE INTO `skinning_loot_template` (`Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`) VALUES
	...
	(60021, 8171, 0, 6, 0, 1, 1, 1, 1, 'Rugged Hide'),
	(60021, 8170, 0, 57, 0, 1, 1, 1, 1, 'Rugged Leather'),
	...
	(60007, 15416, 0, 9, 0, 1, 1, 1, 1, 'Black Dragonscale'),
	...
	(60007, 8165, 0, 8, 0, 1, 1, 1, 1, 'Worn Dragonscale'),
